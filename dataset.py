...
class GRUDataset(Dataset):
    def __init__(self, u2seq, genre_df=None, mode='train',max_length=200,pad_token=0,pad_genre_token=0):
        """
        Parameters
        ----------
        u2seq : dictionary
    ...
    def __getitem__(self, index):
        ...
        if self.genre_df is not None:
            ...
            return torch.LongTensor(tokens), torch.LongTensor(genres) , torch.LongTensor(labels),torch.LongTensor([x_len]),torch.LongTensor([user])
